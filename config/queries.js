...
//         return `SELECT Count(${dbc.Characteristics_Table_Name}.${dbc.Characteristic_Contact_ID})
//         FROM ${dbc.Characteristics_Table_Name}
//         WHERE ${dbc.Characteristics_Table_Name}.${dbc.Characteristic_Contact_ID} = ${contactID}`;
//     }
//
...
//     FROM Characteristics WHERE ${dbc.Characteristic_Contact_ID} = ?`;
//
//     static categoriesByID = `SELECT *
//     FROM Category WHERE ${dbc.Category_Contact_ID} = ?`;
//
...
//
//     static Select_All_Characteristics = `SELECT * FROM ${dbc.Characteristics_Table_Name}`;
//
